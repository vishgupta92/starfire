...
//    public Finding_input getHasParent() {
//        return (Finding_input) getPropertyValueAs(getHasParentProperty(), Finding_input.class);
//    }
    public Set getHasParent() {
        return (Set) getPropertyValueAs(getHasParentProperty(), Finding_input.class);
    }
    ...
    public Set getIsParentOf() {
        return (Set) getPropertyValueAs(getIsParentOfProperty(), Resident.class);
    }
//    public Resident getIsParentOf() {
//        return (Resident) getPropertyValueAs(getIsParentOfProperty(), Resident.class);
//    }
