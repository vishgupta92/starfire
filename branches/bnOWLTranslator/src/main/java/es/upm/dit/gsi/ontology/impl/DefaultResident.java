...
public class DefaultResident extends DefaultNode
    ...
    public Set<DefaultCategoricalRVState> getHasPossibleValues() {
        return new HashSet<DefaultCategoricalRVState>(getPropertyValuesAs(getHasPossibleValuesProperty(), Entity.class));
    }
