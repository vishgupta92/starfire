 ...
 */
public interface RequiredDataCondition extends Condition {

    // Property http://www.owl-ontologies.com/P2PDiagnosis.owl#requiredDataType

    String getRequiredDataType();

    RDFProperty getRequiredDataTypeProperty();

    boolean hasRequiredDataType();

    void setRequiredDataType(String newRequiredDataType);
}
